...
class SummonElemental extends React.Component {
    render() {
        return (
            <div className="SummonElemental">
                <div className="SpellHeading"><h1 className="SpellTitle">Summon Elemental</h1><i className="i-concentration">Concentration</i></div>
                        ...
                        <section className="detailContent">
                            <div className="statBlock">
                                ...
                                <div className="more-info-content">
                                    ...
                                    <span className="components-blurb">* - (air, a pebble, ash, and water inside a gold-inlaid vial worth at least 400 gp)</span>
