...
class SummonFey extends React.Component {
    render() {
        return (
            <div className="SummonFey">
                <div className="SpellHeading"><h1 className="SpellTitle">Summon Fey</h1><i className="i-concentration">Concentration</i></div>
                        ...
                        <section className="detailContent">
                            <div className="statBlock">
                                ...
                                <div className="more-info-content">
                                    ...
                                    <span className="components-blurb">* - (a gilded flower worth at least 300 gp)</span>
